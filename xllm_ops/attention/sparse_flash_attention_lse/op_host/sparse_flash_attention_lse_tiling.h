...
/*!
 * \file sparse_flash_attention_lse_tiling.h
 * \brief
 */
#ifndef SPARSE_FLASH_ATTENTION_LSE_TILING_H
#define SPARSE_FLASH_ATTENTION_LSE_TILING_H
...
// -----------算子TilingData定义---------------
BEGIN_TILING_DATA_DEF(SparseFlashAttentionLseBaseParamsMla)
...
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(SparseFlashAttentionLseBaseParamsMlaOp, SparseFlashAttentionLseBaseParamsMla)

BEGIN_TILING_DATA_DEF(SparseFlashAttentionLseSingleCoreParamsMla)
TILING_DATA_FIELD_DEF(uint32_t, usedCoreNum);
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(SparseFlashAttentionLseSingleCoreParamsMlaOp, SparseFlashAttentionLseSingleCoreParamsMla)

BEGIN_TILING_DATA_DEF(SparseFlashAttentionLseSingleCoreTensorSizeMla)
TILING_DATA_FIELD_DEF(uint32_t, mmResUbSize);
TILING_DATA_FIELD_DEF(uint32_t, bmm2ResUbSize);
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(SparseFlashAttentionLseSingleCoreTensorSizeMlaOp, SparseFlashAttentionLseSingleCoreTensorSizeMla)

BEGIN_TILING_DATA_DEF(SparseFlashAttentionLseSplitKVParamsMla)
...
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(SparseFlashAttentionLseSplitKVParamsMlaOp, SparseFlashAttentionLseSplitKVParamsMla)

// 内切基本块参数
BEGIN_TILING_DATA_DEF(SparseFlashAttentionLseInnerSplitParams)
TILING_DATA_FIELD_DEF(uint32_t, mBaseSize)
TILING_DATA_FIELD_DEF(uint32_t, s2BaseSize)
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(SparseFlashAttentionLseInnerSplitParamsOp, SparseFlashAttentionLseInnerSplitParams)

BEGIN_TILING_DATA_DEF(SparseFlashAttentionLseTilingDataMla)
TILING_DATA_FIELD_DEF_STRUCT(SparseFlashAttentionLseBaseParamsMla, baseParams);
TILING_DATA_FIELD_DEF_STRUCT(SparseFlashAttentionLseSplitKVParamsMla, splitKVParams);
TILING_DATA_FIELD_DEF_STRUCT(SparseFlashAttentionLseSingleCoreParamsMla, singleCoreParams);
TILING_DATA_FIELD_DEF_STRUCT(SparseFlashAttentionLseSingleCoreTensorSizeMla, singleCoreTensorSize);
TILING_DATA_FIELD_DEF_STRUCT(SparseFlashAttentionLseInnerSplitParams, innerSplitParams);
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(SparseFlashAttentionLse, SparseFlashAttentionLseTilingDataMla)
...
private:
    ...
    SparseFlashAttentionLseTilingDataMla tilingData_;
...
#endif // SPARSE_FLASH_ATTENTION_LSE_TILING_H
